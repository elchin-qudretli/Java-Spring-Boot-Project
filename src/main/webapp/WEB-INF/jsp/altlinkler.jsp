    ...
    <footer class="footer">
    	<div class="container">
      	<div class="row">
        	<div class="col-lg-5 col-md-5 col-sm-5">
          	<div class="info">
              <a class="logo" href="/alleticaret_products"><img src="./resources/img/logo-footer.png" alt="Limo"/></a>
        ...
        <div class="copyright">
        	<div class="row">
          	...
          	<div class="col-lg-5 col-md-5 col-sm-5">
            	<div class="payment">
                <img src="./resources/img/payment/visa.png" alt="Visa"/>
                <img src="./resources/img/payment/paypal.png" alt="PayPal"/>
                <img src="./resources/img/payment/master.png" alt="Master Card"/>
                <img src="./resources/img/payment/discover.png" alt="Discover"/>
                <img src="./resources/img/payment/amazon.png" alt="Amazon"/>
              </div>
            </div>
          </div>
        </div>
